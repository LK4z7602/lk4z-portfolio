...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description: "Comecei a construir projetos responsivos e interativos com HTML e CSS, começando os estudos de JavaScript",
    icon: CodeOutlinedIcon,
  },
  {
    year: "Ago 2025",
    title: "Projetos Aprimorados",
    description: "Construí projetos grandes com HTML, CSS e JS, implementando novas tecnologias. Começando o estudo em React e TypeScript",
    icon: ElectricBoltOutlinedIcon,
  },
  {
    year: "Dec 2025 - Presente",
    title: "Expandindo Portfólio",
    description: "Construindo projetos reais e ampliando habilidades técnicas, testando novas tecnologias e contruindo projetos escaláveis",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-lg text-gray-400 leading-relaxed">
              Sou o Lucas, um desenvolvedor web apaixonado por criar websites e aplicações incríveis e performáticas. 
              <span className="hidden sm:block">Desde o início da minha jornada, tenho me dedicado a aprender e aprimorar habilidades no ramo web, e sempre em busca de conhecimentos novos para expandir minha gama de tecnologias.</span>Atualmente foocado no ecossistema React, usando TypeScript e Tailwind, mas sempre aberto a explorar novas tecnologias e desafios.
            </p>
          </motion.div>
